 ...
 *
 * <p>Deliberately thin: it owns the JavaFX {@link Application}/{@link Stage}/{@link Scene} lifecycle
 * and the single shared toolkit wiring (one {@link FxBus} feeding {@link FxExec} and the
 * {@link StatusBarModel}), constructs the collaborators, then delegates all UI and behaviour to
 * {@link MainView}. It also opens a file passed on the command line (how file associations invoke the
...
public final class LetterbladeApp extends Application {
	...
	public void start(Stage stage) {
		...
		final MainView view = new MainView(exec, msgService, sanitizer, notifications, statusBarModel,
				stage::setTitle);
