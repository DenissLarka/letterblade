...
/**
 * Which source produced the message body that will be rendered, and how the Rendered/Plain view
 * should default. Outlook usually stores the body as RTF, so {@link #RTF_CONVERTED} is the common
 * case; a native HTML body ({@link #HTML}) or a plain-text-only message ({@link #TEXT_ONLY}) also
 * occur.
 */
