...
/**
 * Pure unit tests of {@link MsgService#deriveBody}. Because no real Outlook {@code .msg} fixture carries a native
 * {@code getBodyHTML()} (Outlook stores RTF), the HTML and TEXT_ONLY branches are covered here with synthetic inputs;
 * the RTF_CONVERTED branch is additionally exercised against real fixtures in {@link MsgServiceTest}.
 */
